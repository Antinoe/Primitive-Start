...
using PrimitiveStart.Projectiles;
...
namespace PrimitiveStart.Items.Weapons
{
	public class WoodenStake : ModItem
	{
		...
		{
			Item.damage = PrimitiveStartConfig.Instance.weaponsWoodenStakeDamage;
			Item.width = 16;
			Item.height = 16;
			Item.scale = 1f;
			Item.useTime = PrimitiveStartConfig.Instance.weaponsWoodenStakeUseTime;
			Item.useAnimation = PrimitiveStartConfig.Instance.weaponsWoodenStakeUseTime;
